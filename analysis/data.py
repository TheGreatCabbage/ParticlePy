...
# This is just to maintain compatibility across older files, while making the name clearer.
file_pi_600 = file_pi
...
class Data:
    ...
    def map(self, function):
        """
        Return a new data object, using all the datum objects
        from this object mapped by a function.
        """
        return Data([function(i) for i in self.data if i ])
